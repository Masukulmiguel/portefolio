...
export const technologies: Technology[] = [
  { name: "Python", category: "languages", icon: "/images/tech/python.svg", level: "expert" },
  { name: "PHP", category: "languages", icon: "/images/tech/php.svg", level: "expert" },
  { name: "JavaScript", category: "languages", icon: "/images/tech/javascript.svg", level: "expert" },
  { name: "TypeScript", category: "languages", icon: "/images/tech/typescript.svg", level: "advanced" },
  {
    name: "React",
    category: "frontend",
  ...
  },
  {
    name: "Vue.js",
    category: "frontend",
    icon: "/images/tech/vuedotjs.svg",
    level: "advanced",
  },
  {
    name: "Node.js",
    category: "backend",
    icon: "/images/tech/nodedotjs.svg",
    level: "advanced",
  },
  {
    name: "Tailwind CSS",
  ...
  },
  {
    name: "Proxmox",
    category: "devops",
    icon: "/images/tech/proxmox.svg",
    level: "advanced",
  },
  {
    name: "Mikrotik",
    category: "networking",
    icon: "/images/tech/mikrotik.svg",
    level: "advanced",
  },
  {
    name: "Cisco",
    category: "networking",
    icon: "/images/tech/cisco.svg",
    level: "advanced",
  },
  {
    name: "OpenAI",
  ...
  },
  {
    name: "n8n",
    category: "devops",
    icon: "/images/tech/n8n.svg",
    level: "advanced",
  },
  {
    name: "REST API",
    category: "backend",
    icon: "/images/tech/restapi.svg",
    level: "expert",
  },
  {
    name: "GraphQL",
  ...
  },
  {
    name: "Hikvision",
    category: "tools",
    icon: "/images/tech/hikvision.svg",
    level: "expert",
  },
  {
    name: "CCTV",
